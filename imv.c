...
// DBJ: #define _WIN32_WINNT 0x0500
#include <windows.h>
#include <stdio.h>
#include <time.h>
#include <string.h>
...
#ifdef _DEBUG
char* displayName = "DEBUG | imv(stb) | MSVC 2021 build (c) dbj@dbj.org";
#else
char *displayName = "imv(stb) | MSVC 2021 build (c) dbj@dbj.org";
#endif // ! _DEBUG
...
char helptext_right[] =
   ...
   "CTRL-C: copy filename to clipboard\n"
    ...
    "----------------------------------\n"
    "2021 MSVC Build (c) by dbj@dbj.org\n"
;
